...
# Maintain the order of import if latter depends on the former.
from . import subdir1
...
# By commenting this __all__ variable, we understand that this naming the
# sub packages is not necessary.
